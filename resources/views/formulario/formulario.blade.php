        ...
        <div class="salary-info">
            ...
            <div class="signature-date">
              ...
              <div class="responsible-signature-report">
                <label for="responsible-signature-report" class="signature-label">Firma Responsable del Informe</label>
            ...
            <!-- <div class="for-payments"> -->
              <div class="label-input-group">
                <label for="quincena" class="quincena-label">Quincenales:</label>
                <input type="text" id="quincena" name="quincena" required>
              </div>
              <div class="label-input-group">
                <label for="mensual" class="mensual-label">mensuales:</label>
                <input type="text" id="mensual" name="mensual" required>
              </div>
              <div class="label-input-group">
